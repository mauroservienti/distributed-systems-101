...
(async () => {
    ...
    const inputQ = "publish-multi-subscribe-another-subscriber-endpoint";
    const exchange = "publish-multi-subscribe-something-happened";
    const routingKey = "publish-multi-subscribe-something-happened";
